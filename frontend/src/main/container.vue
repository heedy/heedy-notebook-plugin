  ...
  <v-flex>
    <v-card>
      ...
      <notebook
        ...
        :readonly="readonly"
        @update="
          (c) => $store.commit('addNotebookUpdate', { id: object.id, data: c })
        "
        @undo="
          (c) =>
            $store.commit('undoNotebookUpdates', { id: object.id, data: c })
        "
        @run="
          (c) => $store.dispatch('runNotebookCell', { id: object.id, data: c })
        "
